...
export default function (context, pluginCallButtons, plugins, lang, _options) {
    ...
    const core = {
        ...
        /**
         * @description Elements and user options parameters of the keditor
         */
        context: context,
        ...
        callPlugin: function (pluginName, callBackFunction) {
            if (!this.plugins[pluginName]) {
                throw Error('[KEDITOR.core.callPlugin.fail] The called plugin does not exist or is in an invalid format. (pluginName:"' + pluginName + '")');
            ...
            switch (command) {
                ...
                case 'save':
                    if (typeof context.option.callBackSave === 'function') {
                        ...
                        throw Error('[KEDITOR.core.commandHandler.fail] Please register call back function in creation option. (callBackSave : Function)');
                    }
        ...
        print: function () {
            ...
            contents.className = 'keditor-editable';
            ...
            try {
                ...
                throw Error('[KEDITOR.core.print.fail] error: ' + error);
            } finally {
        ...
        preview: function () {
            ...
            if (context.option.fullPage) {
                ...
                windowObject.document.write('' +
                    ...
                    '<style>' + cssText + '</style>' +
                    '</head>' +
                    '<body class="keditor-editable">' + contentsHTML + '</body>' +
                    '</html>'
                );
            }
        },
...
         * When created as an Iframe, the event of the document inside the Iframe is also removed.
        ...
        _init: function () {
            ...
            core.codeViewDisabledButtons = context.element.toolbar.querySelectorAll('.ke-toolbar button:not([class~="code-view-enabled"])');
    ...
    const event = {
        ...
        onMouseDown_toolbar: function (e) {
            ...
            if (util.getParentElement(target, '.ke-submenu')) {
                ...
                while (!command && !/ke-menu-list/.test(className) && !/ke-toolbar/.test(className)) {
                ...
                case 46: /** delete key */
                    ...
                    if ((util.isFormatElement(selectionNode) || selectionNode.nextSibling === null) && range.startOffset === selectionNode.textContent.length) {
                        ...
                        if (util.isComponent(nextEl)) {
                            ...
                            if (util.hasClass(nextEl, 'ke-component') || /^IMG$/i.test(nextEl.nodeName)) {
                                e.stopPropagation();
                                if (util.hasClass(nextEl, 'ke-image-container') || /^IMG$/i.test(nextEl.nodeName)) {
    ...
    const userFunction = {
        ...
        /**
         * @description Gets the keditor's context object. Contains settings, plugins, and cached element objects
         * @returns {Object}
         */
        getContext: function () {
            return context;
        ...
        /**
         * @description Gets the contents of the keditor
         * @returns {String}
         */
        getContents: function () {
        ...
        /**
         * @description Change the contents of the keditor
        ...
        /**
         * @description Add contents to the keditor
         * @param {String} contents Contents to Input
         */
        ...
        /**
         * @description Disable the keditor
         */
        disabled: function () {
        ...
        /**
         * @description Enabled the keditor
         */
        enabled: function () {
        ...
        /**
         * @description Destroy the keditor
         */
        destroy: function () {
